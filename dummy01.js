...
app.get('/api/organisations', (req, res) => {
  ...
  const data = [
    { id: 1, organisation_name: 'Organisation 1', shortName: 'Org 1', mediaName: 'Organisation 1 Media', parentOrgId: 0, organisation_country: 'SWE' },
    { id: 2, organisation_name: 'Organisation 2', shortName: 'Org 2', mediaName: 'Organisation 2 Media', parentOrgId: 1, organisation_country: 'SWE' },
